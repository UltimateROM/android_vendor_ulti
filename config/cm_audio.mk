...
ALARM_PATH := vendor/ulti/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/ulti/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/ulti/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/ulti/prebuilt/common/media/audio/ui
